...
public class DetInvTranMatController implements Initializable {
	...
	@FXML
	protected void inv(ActionEvent event) throws IOException {
		...
		control.criaMat();
		control.mat1 = desconvert(op.inversaMatriz(convert(mat1, l1, c1)), l1, c1);
	...
	@FXML
	protected void det(ActionEvent event) throws IOException {

		result = op.determinanteMatriz(convert(mat1, l1, c1));
		det.setText(String.valueOf(result));

	}

	@FXML
	protected void trans(ActionEvent event) throws IOException {
		Node node = (Node) event.getSource();
		...
		control.mat1 = desconvert(op.transpostaMatriz(convert(mat1, l1, c1)), c1, l1);

		control.exibirMatz(c1, l1);
